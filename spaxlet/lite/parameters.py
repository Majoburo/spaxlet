# This module contains functions and classes for parameters in spaxlet lite.
# Unlike spaxlet main, a LiteParameter contains all of the information
...
class LiteParameter(ABC):
    ...
    Unlike the main spaxlet `Parameter` class,
