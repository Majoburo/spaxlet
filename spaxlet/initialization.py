...
logger = logging.getLogger("spaxlet.initialisation")
...
def build_initialization_image(observations, spectra=None):
    ...
    Parameters
    ----------
    observations: list of `~spaxlet.observation.Observation`
...
def init_source(
    ...
    for the modeled source. If spaxlet cannot initialize a
    ...
    It is possible that spaxlet will be unable to initialize a
