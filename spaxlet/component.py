...
class Component(Model):
    ...
    parameters: list of `~spaxlet.Parameter`
    children: list of `~spaxlet.Model`
        Subordinate models.
    bbox: `~spaxlet.Box`
...
class FactorizedComponent(Component):
    ...
    spectrum: `~spaxlet.Spectrum`
        Parameterization of the spectrum
    morphology: `~spaxlet.Morphology`
...
class CombinedComponent(Component):
    """Combination of multiple `~spaxlet.Component` instances

    Parameters
    ----------
    components: list of `~spaxlet.Component`
