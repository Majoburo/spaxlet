...
Put these two files together in a data folder:
...
In the first code cell, change `DATA_ROOT` to the location of your data folder,
then run all cells. The notebook runs A, B, and C automatically and may take a
while.

If installation reports that developer tools are missing, run
