...
ext_modules = [
    Extension(
        "spaxlet.operators_pybind11",
        ["spaxlet/operators_pybind11.cc"],
        include_dirs=[
            get_pybind_include(),
    ...
    Extension(
        "spaxlet.detect_pybind11",
        ["spaxlet/detect_pybind11.cc"],
        include_dirs=[
            get_pybind_include(),
            get_pybind_include(user=True),
            get_eigen_include(),
...
# using `spaxlet.__version__`
pkg_version = version.get_version()
f = open("spaxlet/_version.py", "w")
...
setup(
    ...
    description="Blind Source Separation using proximal matrix factorization (IFU-focused fork of scarlet)",
    author="Fred Moolekamp and Peter Melchior",
    author_email="peter.m.melchior@gmail.com",
    url="https://github.com/pmelchior/scarlet",
    keywords=["astro", "deblending", "photometry", "nmf", "ifu"],
